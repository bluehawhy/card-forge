...
- 핵심 선택: 지금 5장을 팔 것인가, 광고를 보고 더 높은 강화 가치에 도전할 것인가

카드를 파괴하는 v1의 손실 구조를 제거한다. 강화에 실패한 카드는 현재 단계를 유지하되 추가 강화만 잠기므로 사용자는 반드시 판매 가치를 보존한다.
...
기상청이나 위치 정보에 의존하지 않는 게임 내 가상 기후다. 서버가 맑음·흐림·비·강풍·폭염·황사를 무작위 순서로 섞어 24시간마다 하나씩 적용한다.
...
| 카드 보관함 | 원소·등급·강화·잠금 상태 필터, 5장 판매 선택 |
| 대장간 | 강화 확률·실패 잠금·가치 고지, 강화 광고와 결과 |
| 판매 | 카드 5장 가치, 첫 판매 원소 보너스, 판매 광고 |
